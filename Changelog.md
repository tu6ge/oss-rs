## 2022-11-08, Version 0.9.0
### Commits
- [[`4c7f8fefaf`](https://github.com/tu6ge/oss-rs/commit/4c7f8fefafb87d990af0155df585e0508589794f)] chore(version) (tu6ge)
- [[`e4553f7d74`](https://github.com/tu6ge/oss-rs/commit/e4553f7d74fce682d802f8fb073943387796df29)] fix(auth): Prevent secret exposure (tu6ge)
- [[`61da9b2e29`](https://github.com/tu6ge/oss-rs/commit/61da9b2e29a9500f571ea5a1ceed6cf997b295b6)] feat(auth): set all field to private (tu6ge)
- [[`6073ad8365`](https://github.com/tu6ge/oss-rs/commit/6073ad83654d048c842a59fb62b4f91e8c169469)] feat(client): set middleware pub(crate) (tu6ge)
- [[`b7c4127e94`](https://github.com/tu6ge/oss-rs/commit/b7c4127e940d39dbb7a5c0950a05b7704547e75a)] chore: support enum default derive (tu6ge)
- [[`f3ebb70748`](https://github.com/tu6ge/oss-rs/commit/f3ebb70748ee0ce6234f42b51ae3a1415148cbd8)] fix(client): ignore put_content example (tu6ge)
- [[`04b1cff27c`](https://github.com/tu6ge/oss-rs/commit/04b1cff27c2dcf2a4fd233858ef6b18ab813f352)] feat(client): remove infer field (tu6ge)
- [[`b5f1f4a1ab`](https://github.com/tu6ge/oss-rs/commit/b5f1f4a1ab1f0e178f09d6f80e024483d3925f7a)] docs (tu6ge)
- [[`cdba8771fe`](https://github.com/tu6ge/oss-rs/commit/cdba8771fe86c8e5c8458edbe235803cd302ec05)] docs (tu6ge)
- [[`7c97c9a549`](https://github.com/tu6ge/oss-rs/commit/7c97c9a5491fcb2752be224b43ad5a27b7ae3642)] style (tu6ge)
- [[`d7f32bf0ea`](https://github.com/tu6ge/oss-rs/commit/d7f32bf0ea8dc468b4f5c12627cba115fdf13021)] fix(types): ContentRange i32 update to u32 (tu6ge)
- [[`be828e136a`](https://github.com/tu6ge/oss-rs/commit/be828e136a90facf71a695270cc5e67a57262917)] feat(object): Add get_object method (tu6ge)
- [[`8448a4d536`](https://github.com/tu6ge/oss-rs/commit/8448a4d5365c59b4ebc584b15db41759aa3eac37)] prefact(auth): add filter_map (tu6ge)
- [[`ccdb8a9e0b`](https://github.com/tu6ge/oss-rs/commit/ccdb8a9e0b43e50c2e07303702e6a0ba8d389897)] chore(changelog) (tu6ge)
- [[`af0e99de79`](https://github.com/tu6ge/oss-rs/commit/af0e99de7991244a030c3ad6e450243d77d671dc)] Update Changelog.md (tu6ge)
...
```diff
 ...
 Changelog.md                  | 176 +++++++++++++++++++++++++++++++++++++-
 README.md                     |  27 ++++--
 examples/objects.rs           |  21 +---
 examples/sts.rs               |   2 +-
 src/auth.rs                   | 197 ++++++++++++++++++++++++++----------------
 src/blocking/builder.rs       |   2 +-
 src/blocking/mod.rs           | 141 ++++++++++++++++++++++++++++++-
 src/bucket.rs                 |  17 +----
 src/builder.rs                |   2 +-
 src/client.rs                 |  34 +++----
 src/errors.rs                 |   1 +-
 ...
 src/object.rs                 | 174 +++++++++++++++++++++++++------------
 src/sts.rs                    |  24 +++++-
 src/tests/auth.rs             | 137 +++++++++--------------------
 src/tests/object.rs           | 203 +++++++++++++++++++++++++++++++++++++++++++-
 src/types.rs                  |  82 +++++++++++++++--
 19 files changed, 1036 insertions(+), 297 deletions(-)
```
